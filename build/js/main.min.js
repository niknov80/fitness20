...
var _initAccordion = require("./modules/accordions/init-accordion.js");
...
},{"./modules/accordions/init-accordion.js":3,"./modules/form-validate/form":5,"./modules/slider.js":11,"./modules/tabs/init-tabs.js":12,"./modules/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.sliderInit = void 0;
var sliderInit = function sliderInit() {
  var swiper = new Swiper('.trainers__slider', {
  ...
  var reviweSlider = new Swiper('.reviews__slider', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
    slidesPerGroup: 1,
...
},{"./tabs.js":13}],13:[function(require,module,exports){
"use strict";
...
var setupVideo = function setupVideo(video) {
  ...
  var mediaUrl = link.href;
  var wrap = video.querySelector('.video__wrapper');
  button.addEventListener('click', function () {
    var iframe = createIframe(mediaUrl);
    wrap.remove();
    video.appendChild(iframe);
  });
  link.removeAttribute('href');
};
var createIframe = function createIframe(url) {
